...
input_source = "dancing_videos/poledance.mp4"
cap = cv2.VideoCapture(input_source)
#cap = cv2.VideoCapture(0)
hasFrame, frame = cap.read()

fourcc = cv2.VideoWriter_fourcc(*'DIVX')  # 'x264' doesn't work
outVideo = cv2.VideoWriter('dancing_videos/out_poledance.mp4',fourcc, 30, (480, 360), True) 
...
while counter < 500 and cv2.waitKey(1) < 0:
    print(counter)
    t = time.time()
    hasFrame, frame = cap.read()
